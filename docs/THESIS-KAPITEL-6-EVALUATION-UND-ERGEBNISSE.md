...
Die Messergebnisse umfassen quantitative Metriken wie Build- und Testzeiten, Erfolgs- und Fehlerraten sowie Konfigurationsaufwand. Zusätzlich wurden qualitative Bewertungen für Benutzerfreundlichkeit, Dokumentation und KI-Unterstützung durchgeführt. Die Ergebnisse werden im Folgenden detailliert dargestellt und analysiert.
...
GitHub Actions zeigte eine Gesamtausführungszeit von 4 Minuten und 57 Sekunden (297 Sekunden) für eine vollständige Pipeline-Ausführung auf dem main-Branch. Die Lint-Stage benötigte 19 Sekunden für Backend und 10 Sekunden für Frontend, wobei beide Jobs parallel ausgeführt wurden. Die Test-Stage dauerte 20 Sekunden für Backend-Tests und 19 Sekunden für Frontend-Tests, ebenfalls parallel ausgeführt. Der Frontend-Build benötigte 21 Sekunden. Die E2E-Tests, die die Installation von Playwright-Browsern, das Starten der Server und die Test-Ausführung umfassen, benötigten 2 Minuten und 9 Sekunden (129 Sekunden) und stellten damit den zeitintensivsten Stage dar. Die Docker-Build-Stage, die nur auf main- und develop-Branches ausgeführt wurde, benötigte 1 Minute und 46 Sekunden (106 Sekunden). Die Deploy-Stage für Production benötigte 7 Sekunden. Die Pipeline generierte 4 Artifacts, die für 7 Tage gespeichert wurden.

GitLab CI zeigte eine Gesamtausführungszeit von 8 Minuten und 12 Sekunden (492 Sekunden) für eine vollständige Pipeline-Ausführung. Die Pipeline umfasste insgesamt 8 Jobs, die über 5 Stages verteilt waren: lint, test, build, e2e und deploy. Die Pipeline wurde für den main-Branch ausgeführt und war 3 Sekunden in der Warteschlange. Die parallele Ausführung der Lint- und Test-Jobs reduzierte die Gesamtausführungszeit erheblich. Die Docker-Build-Jobs waren in der verwendeten Konfiguration deaktiviert, da Docker-in-Docker auf dem Shared Runner nicht verfügbar war, was eine Limitation der Testumgebung darstellte, nicht der Plattform selbst.

Jenkins zeigte die schnellste Gesamtausführungszeit von 3 Minuten und 38 Sekunden (218 Sekunden) für eine vollständige Pipeline-Ausführung. Die Pipeline wurde manuell ausgelöst und war nur 2 Millisekunden in der Warteschlange. Die Lint-Stage führte Backend- und Frontend-Lint parallel aus, was die Effizienz erhöhte. Die Test-Stage führte ebenfalls Backend- und Frontend-Tests parallel aus. Die Docker-Build- und Deploy-Stages wurden in dieser Ausführung übersprungen, da sie bedingt auf bestimmte Branches ausgeführt werden. Die Pipeline zeigte eine klare visuelle Darstellung der Stages mit erfolgreichen Abschlüssen für alle ausgeführt Jobs.
...
Die E2E-Tests stellten bei GitHub Actions den zeitintensivsten Stage dar mit 129 Sekunden, was auf die Installation von Playwright-Browsern, das Starten der Backend- und Frontend-Server und die Ausführung der Tests zurückzuführen ist. Die Docker-Build-Stage benötigte 106 Sekunden, was ebenfalls einen erheblichen Anteil an der Gesamtausführungszeit ausmachte. Die Deploy-Stage war mit 7 Sekunden sehr schnell, da sie nur eine Simulation darstellte.
...
xychart-beta
    ...
    y-axis "Wert" 0 --> 120
    bar "GitHub Actions" [52, 327, 8, 2]
    bar "GitLab CI" [60, 297, 5, 4]
    bar "Jenkins" [105, 293, 6, 6]
```
